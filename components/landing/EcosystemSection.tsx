...
import { TrendingDown, ShieldCheck, FileText, CheckCircle2, Shield } from "lucide-react";
    ...
    <section id="ecosystem" className="py-12 sm:py-16 space-y-12">
      ...
      <div className="p-8 sm:p-12 rounded-3xl bg-surface border border-tint-brown/30 shadow-soft text-right space-y-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-2xl bg-tint-blue text-primary-blue flex items-center justify-center font-bold">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-2xl bg-tint-green text-accent-green flex items-center justify-center font-bold">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-2xl bg-tint-brown text-warm-brown flex items-center justify-center font-bold">
        ...
        <div className="p-6 rounded-2xl bg-bg-main border border-tint-brown/30 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-surface border border-tint-brown/40 flex items-center justify-center text-primary-blue shadow-xs">
          ...
          <div className="flex items-center gap-2 text-xs font-semibold text-accent-green bg-surface px-3.5 py-2 rounded-xl border border-tint-brown/30">
